...
public class SViewItem extends SGridPaneView {
    ...
    public SViewItem(SGuiClient client, String title) {
        super(client, SGridConsts.GRID_PANE_VIEW, SModConsts.OU_ITM, SLibConsts.UNDEFINED, title);
    }
    ...
    public void prepareSqlQuery() {
        ...
        msSql = "SELECT "
                ...
                + "FROM " + SModConsts.TablesMap.get(SModConsts.OU_ITM) + " AS v "
    ...
    public ArrayList<SGridColumnView> createGridColumns() {
        ...
        columns.add(new SGridColumnView(SGridConsts.COL_TYPE_DEC_AMT_UNIT, "v.prc_unt", "Precio u. $"));
